...
- **数据规模**：500例(共2000例，需要联系作者)

- **格式**：标注格式:JSON，编号加标签：；影像大小:2440 x 1280：；影像格式:.jpg：
...
- **格式**：标注格式：JSON ；影像大小：720 x 401；影像格式：.jpg
- **应用方向**：牙齿精细分割

**下载地址**：[数据集地址](https://github.com/Zzz512/TSD)

**相关论文**：DSIS-DPR:Structured Instance Segmentation and Diffusion Prior Refinement for Dental Anatomy Learning
...
- **格式**：标注格式：，包括解剖位置、周边特征、放射密度、对周围结构的影响以及异常类别；影像大小：；影像格式：
- **应用方向**：
...
- **数据特点**：原始图像进行了缩放、旋转、翻转和添加噪声等处理,包含原始 JPG 图像、增强 JPG 图像、图像标注三个文件

- **数据规模**：3926例

- **格式**：标注格式：；影像大小：；影像格式:.jpg
- **应用方向**：根尖周炎检测
...
- **数据特点**：数据分为训练集（Train）、验证集（Valid）和测试集（Test）

- **数据规模**：1345/4772/2071

- **格式**：标注格式：JSON；影像大小：640*640；影像格式：.jpg
- **应用方向**：牙齿检测
